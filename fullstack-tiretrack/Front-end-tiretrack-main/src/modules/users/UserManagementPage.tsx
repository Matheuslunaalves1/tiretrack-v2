  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const empresas = Array.isArray(empResponse) ? empResponse : (empResponse as any).data || [];
        const users = Array.isArray(userResponse) ? userResponse : (userResponse as any).data || [];
